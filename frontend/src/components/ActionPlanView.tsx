...
import { isOfflineActionPlan } from '../provenance';
...
export function ActionPlanView({ plan, findings }: Props) {
  return (
    <div className="space-y-3">
      {isOfflineActionPlan(plan) && (
        <Alert variant="warning" title="Offline-generated action plan">
          This plan text was generated by the built-in demo model. It has no clinical meaning and
